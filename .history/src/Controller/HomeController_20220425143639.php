...
class HomeController extends AbstractController
{
    ...
    /**
     * @Route("/api/edit/{id}", name="app_put", methods={"PUT"})
     *
     * @param Contact $contact
     * @param EntityManagerInterface $manager
     * @param SerializerInterface $serializer
    ...
    public function put(Contact $contact, EntityManagerInterface $manager, SerializerInterface $serializer, ValidatorInterface $validator): JsonResponse
    {
        ...
        // return une response 204 qui indique que la requête à réussi mais que le client n'a pas besoin de quiiter la page
        return new JsonResponse('salut', JsonResponse::HTTP_NO_CONTENT);
    }
    /**
