...
class HomeController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    public function post(Contact $contact, Request $request, SerializerInterface $serializer, EntityManagerInterface $manager, UrlGeneratorInterface $urlGenerator): JsonResponse
    {
        
        $contactD = $serializer->deserialize($request->getContent(), Contact::class, "json");

        $manager->persist($contactD);
        $manager->flush();
